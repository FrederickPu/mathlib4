...
def Injective.linearOrderedSemifield [LinearOrderedSemifield α] [Zero β] [One β] [Add β] [Mul β]
    [Pow β ℕ] [SMul ℕ β] [NatCast β] [NNRatCast β] [Inv β] [Div β] [Pow β ℤ] [Sup β] [Inf β]
  ...
  __ := hf.semifield f zero one add mul inv div nsmul npow zpow natCast nnratCast
...
def Injective.linearOrderedField [LinearOrderedField α] [Zero β] [One β] [Add β] [Mul β] [Neg β]
    [Sub β] [Pow β ℕ] [SMul ℕ β] [SMul ℤ β] [SMul ℚ β] [NatCast β] [IntCast β] [NNRatCast β]
  ...
  __ := hf.field f zero one add mul neg sub inv div nsmul zsmul qsmul npow zpow natCast intCast
    nnratCast ratCast
